...
#define RCC_ptr ((RCC_TypeDef *) (RCC_BASE)) // Puntero a direcciones de RCC
#define RCC (*RCC_ptr) // Acceso a contenido de RCC
...
#define GPIOA_ptr ((GPIO_TypeDef *) (GPIOA_BASE)) // Puntero a direcciones de GPIOA
#define GPIOA (*GPIOA_ptr) // Acceso a contenido de GPIOA
